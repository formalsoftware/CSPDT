package com.fware.cspdt.cspm.editor.wizards;
...
public class CspMNewFileWizard extends Wizard implements INewWizard {
	...
	/**
	 * Constructor for NewCspFileWizard.
	 */
	public CspMNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new CspMNewFileWizardPage(selection);
		addPage(page);
	}
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status = new Status(IStatus.ERROR, "CspSuite", IStatus.OK, message, null);
