 ...
 */
public class CspMEditorPlugin extends AbstractUIPlugin {

	/** The plug-in ID. */
	public static final String PLUGIN_ID = "CspSuite";

	/** The shared instance. */
	private static CspMEditorPlugin plugin;
	 ...
	 */
	public static CspMEditorPlugin getDefault() {
		return plugin;
	}
